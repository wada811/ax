...
object DetectorGenerator {
    fun Params.generate() {
        File("lint/$upperClassName/src/main/java/com/wada811/adx/$lowerClassName/lint/Use${upperClassMethodName}Detector.kt")
            .writeText(
                """
package com.wada811.adx.$lowerClassName.lint
