...
class UseBundleGetIntegerArrayListDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.bundle.lint.UseBundleGetIntegerArrayListDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.ax.bundle.getIntegerArrayListOrNull
@@ -5 +6
-         bundle.getIntegerArrayList("")
...
@@ -1 +1
+ import com.wada811.ax.bundle.getIntegerArrayListOrThrow
@@ -5 +6
-         bundle.getIntegerArrayList("")
