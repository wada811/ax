...
class UseBundleGetFloatDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.bundle.lint.UseBundleGetFloatDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.adx.bundle.getFloatOrNull
@@ -5 +6
-         bundle.getFloat("")
+         bundle.getFloatOrNull("")
Fix for src/UseBundleGetFloat.kt line 5: Replace with getFloatOrThrow:
@@ -1 +1
+ import com.wada811.adx.bundle.getFloatOrThrow
@@ -5 +6
-         bundle.getFloat("")
