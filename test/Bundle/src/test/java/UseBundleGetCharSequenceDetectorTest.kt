...
class UseBundleGetCharSequenceDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.bundle.lint.UseBundleGetCharSequenceDetector.ISSUE
