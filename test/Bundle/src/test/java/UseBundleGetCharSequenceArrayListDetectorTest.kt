...
class UseBundleGetCharSequenceArrayListDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.bundle.lint.UseBundleGetCharSequenceArrayListDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.adx.bundle.getCharSequenceArrayListOrNull
@@ -5 +6
-         bundle.getCharSequenceArrayList("")
...
@@ -1 +1
+ import com.wada811.adx.bundle.getCharSequenceArrayListOrThrow
@@ -5 +6
-         bundle.getCharSequenceArrayList("")
