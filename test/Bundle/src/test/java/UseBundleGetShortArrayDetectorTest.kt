...
class UseBundleGetShortArrayDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.bundle.lint.UseBundleGetShortArrayDetector.ISSUE
