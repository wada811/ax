...
class UseIntentGetIntegerArrayListExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.intent.lint.UseIntentGetIntegerArrayListExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.adx.intent.getIntegerArrayListExtraOrNull
@@ -5 +6
-         intent.getIntegerArrayListExtra("")
...
@@ -1 +1
+ import com.wada811.adx.intent.getIntegerArrayListExtraOrThrow
@@ -5 +6
-         intent.getIntegerArrayListExtra("")
