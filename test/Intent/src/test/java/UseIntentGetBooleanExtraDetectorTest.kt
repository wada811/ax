...
class UseIntentGetBooleanExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetBooleanExtraDetector.ISSUE
