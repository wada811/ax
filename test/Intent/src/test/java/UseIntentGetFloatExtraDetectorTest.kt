...
class UseIntentGetFloatExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetFloatExtraDetector.ISSUE
