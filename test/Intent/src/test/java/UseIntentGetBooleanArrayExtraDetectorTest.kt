...
class UseIntentGetBooleanArrayExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetBooleanArrayExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.ax.intent.getBooleanArrayExtraOrNull
@@ -5 +6
-         intent.getBooleanArrayExtra("")
...
@@ -1 +1
+ import com.wada811.ax.intent.getBooleanArrayExtraOrThrow
@@ -5 +6
-         intent.getBooleanArrayExtra("")
