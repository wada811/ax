...
class UseIntentGetStringExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetStringExtraDetector.ISSUE
