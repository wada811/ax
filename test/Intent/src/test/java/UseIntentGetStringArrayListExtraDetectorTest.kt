...
class UseIntentGetStringArrayListExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetStringArrayListExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.ax.intent.getStringArrayListExtraOrNull
@@ -5 +6
-         intent.getStringArrayListExtra("")
...
@@ -1 +1
+ import com.wada811.ax.intent.getStringArrayListExtraOrThrow
@@ -5 +6
-         intent.getStringArrayListExtra("")
