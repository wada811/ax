...
class UseIntentGetLongArrayExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.intent.lint.UseIntentGetLongArrayExtraDetector.ISSUE
