...
class UseIntentGetCharSequenceExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.ax.intent.lint.UseIntentGetCharSequenceExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.ax.intent.getCharSequenceExtraOrNull
@@ -5 +6
-         intent.getCharSequenceExtra("")
...
@@ -1 +1
+ import com.wada811.ax.intent.getCharSequenceExtraOrThrow
@@ -5 +6
-         intent.getCharSequenceExtra("")
