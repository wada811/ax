...
class UseIntentGetCharSequenceArrayListExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.intent.lint.UseIntentGetCharSequenceArrayListExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.adx.intent.getCharSequenceArrayListExtraOrNull
@@ -5 +6
-         intent.getCharSequenceArrayListExtra("")
...
@@ -1 +1
+ import com.wada811.adx.intent.getCharSequenceArrayListExtraOrThrow
@@ -5 +6
-         intent.getCharSequenceArrayListExtra("")
