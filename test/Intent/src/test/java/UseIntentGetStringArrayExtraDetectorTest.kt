...
class UseIntentGetStringArrayExtraDetectorTest : DetectorTest {
    override val issue: Issue = com.wada811.adx.intent.lint.UseIntentGetStringArrayExtraDetector.ISSUE
...
@@ -1 +1
+ import com.wada811.adx.intent.getStringArrayExtraOrNull
@@ -5 +6
-         intent.getStringArrayExtra("")
...
@@ -1 +1
+ import com.wada811.adx.intent.getStringArrayExtraOrThrow
@@ -5 +6
-         intent.getStringArrayExtra("")
